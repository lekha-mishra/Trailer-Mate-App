...
public class Treding_Movies_Adapter extends RecyclerView.Adapter<com.example.trailermate.TrailerAdapter.Treding_Movies_Adapter.holder> {
    Context context;
    private List<TrendingResultModel> trendingResultModels;
    String orginalTitle;
    String overview;
    Boolean isSearchMovies;
    String VideoId,maincatimage,maincatimage1;
    ApiInterfaceYoutube  apiInterfaceYoutube;
    ProgressDialog progressDialog;

    public Treding_Movies_Adapter(Context context, List<TrendingResultModel> trendingResultModels, Boolean isSearchMovies) {
        this.context = context;
        this.trendingResultModels = trendingResultModels;
        this.isSearchMovies = isSearchMovies;
    ...
    @NonNull
    @Override
    public com.example.trailermate.TrailerAdapter.Treding_Movies_Adapter.holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(isSearchMovies == true ? R.layout.grid_list_seach_movies : R.layout.grid_list_trending_movie , parent, false);
        return new Treding_Movies_Adapter.holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Treding_Movies_Adapter.holder holder, int position) {
